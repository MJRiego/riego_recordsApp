        ...
        <div class="main-panel">
                                    ...
                                    <div class="addbutton" style="margin-bottom: 50px">
                                        <a href="add-employee.php">
                                            <button type="submit" name="adds"
                                                class="btn btn-info btn-fill pull-right">Add New Employee</button>
                                        </a>
                                    </div>
            ...
            <div class="table-paginate">
                ...
                <ul>
                    ...
                    <?php if ($page > 1): ?>
                        <li>
                            <a href="employees.php?page=<?php echo $page - 1; ?>">
                                < Previous </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($page < $number_of_page - 2): ?>
                        <li>
                            <a href="employees.php?page=<?php echo $number_of_page; ?>">
                                Last >
                            </a>
                        </li>
                    <?php endif; ?>
